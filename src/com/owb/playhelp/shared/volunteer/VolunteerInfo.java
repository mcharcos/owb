package com.owb.playhelp.shared.volunteer;
 ...
 *
 */
@SuppressWarnings("serial") public class VolunteerInfo implements Serializable {
	...
	public VolunteerInfo(String name, String description) {
		this(name);
		this.description = description;
	}
	public VolunteerInfo(String name, String description,String addr, double lat, double lng) {
	...
	public VolunteerInfo(String name, String description,String address, double lat, double lng, String phone, String email, String website) {
