...
public class DBRecordInfo implements Serializable {
	...
	public DBRecordInfo(Integer dbType, String name, String description) {
		this(dbType,name);
		this.description = description;
	}
	public DBRecordInfo(Integer dbType, String name, String description,String addr, double lat, double lng) {
		this(dbType,name,description);
		this.address = addr;
		/*
   ...
   */
	...
	/**
	 * Set the status of the orphanage info
	 * @param status
	 */
	...
	/**
	 * Get the status of the orphanage Info
	 * @return
	 */
	public StandardInfo getStatus(){
		return status;
	}
