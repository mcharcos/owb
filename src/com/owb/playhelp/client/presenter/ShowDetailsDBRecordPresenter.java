...
public class ShowDetailsDBRecordPresenter implements Presenter {
	...
	public ShowDetailsDBRecordPresenter(UserProfileInfo currentUser, 
	...
	public ShowDetailsDBRecordPresenter(DBRecordInfo ngo, UserProfileInfo currentUser, 
			SimpleEventBus eventBus, Display display) {
		this(currentUser, eventBus, display);
		this.ngo = ngo;
	}
