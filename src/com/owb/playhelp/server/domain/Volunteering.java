...
public class Volunteering implements Serializable, Cacheable {
	...
	public static VolunteeringInfo toInfo(Volunteering o) {
		if (o == null)
			return null;

		VolunteeringInfo oInfo = new VolunteeringInfo();
